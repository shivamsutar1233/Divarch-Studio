        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <p className="text-3xl font-bold text-gray-900 mb-2">5-9 days</p>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-medium text-gray-900">Expedited</h3>
              ...
              <p className="text-gray-600 mb-4">Faster delivery times</p>
              <ul className="space-y-3 text-sm text-gray-600">
                <li className="flex items-center">
                  <svg
                    className="h-5 w-5 text-green-500 mr-2"
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-medium text-gray-900">Overnight</h3>
                <span className="px-3 py-1 text-sm text-purple-700 bg-purple-100 rounded-full">
                  Premium
                </span>
              </div>
              <p className="text-3xl font-bold text-gray-900 mb-2">Next Day</p>
              <p className="text-gray-600 mb-4">Selected areas only</p>
              <ul className="space-y-3 text-sm text-gray-600">
                <li className="flex items-center">
                  <svg
                    className="h-5 w-5 text-green-500 mr-2"
