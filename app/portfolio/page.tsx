...
export const metadata: Metadata = {
  title: "Portfolio",
  description:
    "Explore Div-Arch Studio's portfolio of 3D printing projects including prototypes, architectural models, and custom installations.",
};
...
const projects = [
  {
    ...
    image: "https://images.unsplash.com/photo-1581092334651-ddf26d9a09d0?ixlib=rb-4.0.3",
  },
  {
    title: "Architectural Model",
    description: "Detailed 3D printed architectural model for client presentation",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1557720667-093b45dde7b9?ixlib=rb-4.0.3",
  },
  {
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1582845512747-e42001c95638?ixlib=rb-4.0.3",
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          <div key={index} className="group">
            <div className="relative overflow-hidden rounded-2xl bg-gray-100 dark:bg-gray-800 h-64">
              <Image
                src={project.image}
                alt={project.title}
                fill
