...
export const metadata: Metadata = {
  title: "Products",
  description:
    "Browse Div-Arch Studio's collection of high-quality 3D printed architectural models and products.",
};
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Please check that PRODUCTS_SHEET_ID is set in your .env.local file.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4">
        ...
        {products.length === 0 ? (
          <div className="text-center py-20 text-gray-500 dark:text-gray-400">
            <p className="text-xl">No products found. Configure your Google Sheet to display products.</p>
          </div>
        ) : (
