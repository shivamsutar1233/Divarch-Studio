...
export const metadata: Metadata = {
  title: "Home",
  description:
    "Div-Arch Studio — Revolutionary 3D printing solutions for architectural models, prototypes, and functional components with precision and innovation.",
};
...
const services = [
  {
    ...
    icon: (
      <svg className="w-6 h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 3v4a1 1 0 001 1h4M5 8v12a1 1 0 001 1h12a1 1 0 001-1V8M5 8l7-5 7 5M10 21v-5a1 1 0 011-1h2a1 1 0 011 1v5" />
      </svg>
    ),
  },
  {
...
const CheckIcon = () => (
  <svg className="w-6 h-6 text-orange-600 dark:text-orange-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 mb-8">
              ...
              prototypes, and functional components with precision and innovation.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                {["Upload your STL files", "Get instant price estimates", "Choose from multiple materials"].map((item) => (
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700">
                <div className="text-4xl font-bold text-orange-600 dark:text-orange-500 mb-1">24/7</div>
                <div className="text-gray-600 dark:text-gray-400">Instant Pricing</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700">
                <div className="text-4xl font-bold text-orange-600 dark:text-orange-500 mb-1">3+</div>
